...
class PwaMain(http.Controller):
    ...
    def get_app_image_vals(self, website):
        ...
        app_image_48 = "/web/image/website/%s/app_image_512/48x48" % (
            website.id) if website.app_image_512 else 'emipro_theme_base/static/src/img/48x48.png'
        app_image_72 = "/web/image/website/%s/app_image_512/72x72" % (
            website.id) if website.app_image_512 else 'emipro_theme_base/static/src/img/72x72.png'
        app_image_96 = "/web/image/website/%s/app_image_512/96x96" % (
            website.id) if website.app_image_512 else 'emipro_theme_base/static/src/img/96x96.png'
        app_image_144 = "/web/image/website/%s/app_image_512/144x144" % (
            website.id) if website.app_image_512 else 'emipro_theme_base/static/src/img/144x144.png'
        app_image_152 = "/web/image/website/%s/app_image_512/152x152" % (
            website.id) if website.app_image_512 else 'emipro_theme_base/static/src/img/152x152.png'
        app_image_168 = "/web/image/website/%s/app_image_512/168x168" % (
            website.id) if website.app_image_512 else 'emipro_theme_base/static/src/img/168x168.png'
        app_image_192 = "/web/image/website/%s/app_image_512/192x192" % (
            website.id) if website.app_image_512 else 'emipro_theme_base/static/src/img/192x192.png'
        app_image_256 = "/web/image/website/%s/app_image_512/256x256" % (
            website.id) if website.app_image_512 else 'emipro_theme_base/static/src/img/256x256.png'
        app_image_384 = "/web/image/website/%s/app_image_512/384x384" % (
            website.id) if website.app_image_512 else 'emipro_theme_base/static/src/img/384x384.png'
        app_image_512 = "/web/image/website/%s/app_image_512/512x512" % (
            website.id) if website.app_image_512 else 'emipro_theme_base/static/src/img/512x512.png'
        vals = {

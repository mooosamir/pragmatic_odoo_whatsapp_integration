                ...
                for res_partner_id in self.partner_ids:
                    ...
                    if res_partner_id.country_id.phone_code and res_partner_id.mobile:
                        ...
                        if response.status_code == 201 or response.status_code == 200:
                            ...
                            if not json_send_message_response.get('sent') and json_send_message_response.get('error') and json_send_message_response.get('error').get('message') == 'Recipient is not a valid WhatsApp user':
